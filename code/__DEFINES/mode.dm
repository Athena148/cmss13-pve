...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_MRR))
...
GLOBAL_LIST_INIT(ROLES_AI_MARSOC, list(JOB_SQUAD_ELEMENT_LEADER_MARSOC, JOB_SQUAD_SARC_MARSOC, JOB_SQUAD_ASSISTANT_ELEMENT_LEAD_MARSOC, JOB_SQUAD_HEAVY_WEAPONS_OPERATOR_MARSOC, JOB_SQUAD_SPECIAL_WEAPONS_OPERATOR_MARSOC, JOB_SQUAD_ELEMENT_MEMBER_MARSOC, JOB_SQUAD_SAPPER_MARSOC))
